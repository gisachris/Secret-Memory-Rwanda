      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-zinc-900 p-8 rounded-lg">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full p-3 rounded bg-black border border-yellow-400 text-white focus:outline-none focus:ring-2 focus:ring-yellow-400"
              ...
              <div>
                ...
                <textarea
                  className="w-full p-3 rounded bg-black border border-yellow-400 text-white focus:outline-none focus:ring-2 focus:ring-yellow-400 h-32"
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">contact@secretmemoryrwanda.com</p>
                  </div>
                </div>
            ...
            <div className="bg-zinc-900 p-8 rounded-lg">
              <h2 className="text-2xl font-bold text-yellow-400 mb-6">Social Media</h2>
